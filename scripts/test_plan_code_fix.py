...
def test_plan_code_logic():
    ...
    for user_id, length_override, user_pref, expected_plan, expected_atoms, description in test_cases:
        ...
        print(f"\n{status} {description}")
        print(f"   user_id={user_id}, length_override={length_override}, user_pref={user_pref}")
