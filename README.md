...
{"ok":true,"count":2,"atoms":[{"module":"strong_events_alerts","kind":"alert","weight":3,"text":"Окно сильных транзитов: ближайшие 3 дня(ей)."},{"module":"daily_digest","kind":"digest","weight":2,"text":"Daily digest at 08:00: день выглядит продуктивным."}],"text":"Окно сильных транзитов: ближайшие 3 дня(ей).\nDaily digest at 08:00: день выглядит продуктивным.","event":{"user_id":"demo","atoms":2,"text_len":95,"event_id":40}}
