...
class GlobalEvent:
    ...
    Сейчас используем stub-реализацию фаз Луны:
    - одно событие на каждый день;
    - имена фаз циклично перебираются из _PHASE_NAMES;
    - payload["stub"] = True, чтобы явно было видно, что это заглушка.
    """
